      ...
      {item && ledger ? <>
        ...
        <Card className="report-table-card overflow-hidden">
          <div className="overflow-x-auto"><table className="w-full min-w-[1450px] border-collapse text-sm">
            <thead>
              <tr className="stock-ledger-screen-header bg-muted/50"><th rowSpan={2} className="report-th text-left">Date</th><th rowSpan={2} className="report-th text-left">Voucher Type</th><th rowSpan={2} className="report-th text-left">Voucher No.</th><th rowSpan={2} className="report-th text-left">Party / Particulars</th><th rowSpan={2} className="report-th text-left">Narration</th><th colSpan={3} className="report-th text-center text-emerald-700">Inward</th><th colSpan={3} className="report-th text-center text-red-700">Outward</th><th colSpan={3} className="report-th text-center">Balance</th><th rowSpan={2} className="report-th text-right print:hidden">Actions</th></tr>
              ...
              <tr className="stock-ledger-print-header hidden bg-muted/50"><th rowSpan={2} className="report-th text-left">Date</th><th rowSpan={2} className="report-th text-left">Voucher Type</th><th rowSpan={2} className="report-th text-left">Voucher No.</th><th rowSpan={2} className="report-th text-left">Party / Particulars</th><th rowSpan={2} className="report-th text-left">Narration</th><th colSpan={2} className="report-th text-center text-emerald-700">Inward</th><th colSpan={2} className="report-th text-center text-red-700">Outward</th><th colSpan={3} className="report-th text-center">Balance</th></tr>
