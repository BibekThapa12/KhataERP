...
const statementPrintStyles = `
  ...
  .ledger-table th:nth-child(1),.ledger-table td:nth-child(1){width:4%}.ledger-table th:nth-child(2),.ledger-table td:nth-child(2){width:11%}.ledger-table th:nth-child(3),.ledger-table td:nth-child(3){width:10%}.ledger-table th:nth-child(4),.ledger-table td:nth-child(4){width:10%}.ledger-table th:nth-child(5),.ledger-table td:nth-child(5){width:29%}.ledger-table th:nth-child(6),.ledger-table td:nth-child(6),.ledger-table th:nth-child(7),.ledger-table td:nth-child(7),.ledger-table th:nth-child(8),.ledger-table td:nth-child(8){width:12%}
  .group-table th:nth-child(1),.group-table td:nth-child(1){width:4%}.group-table th:nth-child(2),.group-table td:nth-child(2){width:30%}.group-table th:nth-child(3),.group-table td:nth-child(3){width:12%}.group-table th:nth-child(4),.group-table td:nth-child(4){width:11%}.group-table th:nth-child(5),.group-table td:nth-child(5),.group-table th:nth-child(6),.group-table td:nth-child(6){width:14%}.group-table th:nth-child(7),.group-table td:nth-child(7){width:15%}
`
