...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn('text-lg font-serif font-bold leading-none tracking-tight', className)} {...props} />
))
